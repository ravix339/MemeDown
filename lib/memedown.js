...
function generateLine(ctx, lineInfo) {
    ...
    var boundingBox = {
        x0: lineInfo.position[0][0],
        y0: lineInfo.position[0][1],
    ...
    if (lineInfo.basic) {
        ...
        // var baseFont = " " + fontLines.fontSize + "px " + lineInfo.font
        // for (var line of fontLines.lines) {
